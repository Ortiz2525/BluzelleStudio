...
var ShallowWrapper = function () {
  function ShallowWrapper(nodes, root) {
    ...
    if (!root) {
      ...
      var renderer = (0, _getAdapter2['default'])(options).createRenderer((0, _object2['default'])({ mode: 'shallow' }, options));
  ...
  _createClass(ShallowWrapper, [{
      ...
      function rerender(props, context) {
        ...
        this.single('rerender', function () {
          (0, _Utils.withSetStateAllowed)(function () {
            ...
            var prevProps = instance.props || _this[UNRENDERED].props;
            var prevContext = instance.context || _this[OPTIONS].context;
            var nextContext = context || prevContext;
            if (context) {
              _this[OPTIONS] = (0, _object2['default'])({}, _this[OPTIONS], { context: nextContext });
            }
            _this[RENDERER].batchedUpdates(function () {
              ...
              var spy = void 0;
              if (!_this[OPTIONS].disableLifecycleMethods && instance && typeof instance.shouldComponentUpdate === 'function') {
                spy = (0, _Utils.spyMethod)(instance, 'shouldComponentUpdate');
              }
              if (props) _this[UNRENDERED] = (0, _Utils.cloneElement)(adapter, _this[UNRENDERED], props);
              _this[RENDERER].render(_this[UNRENDERED], nextContext);
              if (spy) {
                shouldRender = spy.getLastReturnValue();
                spy.restore();
              }
              if (shouldRender && !_this[OPTIONS].disableLifecycleMethods && instance) {
    ...
    value: function () {
      function setState(state) {
        ...
        this.single('setState', function () {
          (0, _Utils.withSetStateAllowed)(function () {
            var adapter = (0, _getAdapter2['default'])(_this2[OPTIONS]);
            ...
            var spy = void 0;
            var shouldRender = true;
            if (!_this2[OPTIONS].disableLifecycleMethods && lifecycles.componentDidUpdate && lifecycles.componentDidUpdate.onSetState && instance && typeof instance.shouldComponentUpdate === 'function') {
              spy = (0, _Utils.spyMethod)(instance, 'shouldComponentUpdate');
            }
            ...
            if (shouldRender && !_this2[OPTIONS].disableLifecycleMethods && lifecycles.componentDidUpdate && lifecycles.componentDidUpdate.onSetState && instance) {
    ...
    value: function () {
      function containsAllMatchingElements(nodes) {
        ...
        return nodes.every(function (node) {
          return _this3.containsMatchingElement(node);
        });
      }
    ...
    value: function () {
      function equals(node) {
        ...
        return this.single('equals', function () {
          return (0, _Utils.nodeEqual)(_this5.getNodeInternal(), node);
        });
      }
    ...
    value: function () {
      function matchesElement(node) {
        ...
        return this.single('matchesElement', function () {
          ...
          var rstNode = adapter.elementToNode(node);
          return (0, _Utils.nodeMatches)(rstNode, _this6.getNodeInternal(), function (a, b) {
            return a <= b;
          });
        });
      }
    ...
    value: function () {
      function html() {
        ...
        return this.single('html', function (n) {
          if (_this8.type() === null) return null;
          var adapter = (0, _getAdapter2['default'])(_this8[OPTIONS]);
          var renderer = adapter.createRenderer((0, _object2['default'])({}, _this8[OPTIONS], { mode: 'string' }));
    ...
    value: function () {
      function simulate(event) {
        ...
        return this.single('simulate', function (n) {
          ...
          (_RENDERER = _this9[RENDERER]).simulateEvent.apply(_RENDERER, [n, event].concat(args));
          _this9[ROOT].update();
          return _this9;
        });
      }
    ...
    value: function () {
      function parents(selector) {
        ...
        var allParents = this.wrap(this.single('parents', function (n) {
          return (0, _RSTTraversal.parentsOfNode)(n, getRootNodeInternal(_this13));
        }));
    ...
    value: function () {
      function shallow(options) {
        ...
        return this.single('shallow', function (n) {
          return _this14.wrap((0, _getAdapter2['default'])(_this14[OPTIONS]).nodeToElement(n), null, options);
        });
      }
    ...
    value: function () {
      function reduce(fn) {
        ...
        return this.getNodesInternal().reduce(function (accum, n, i) {
          return fn.call(_this17, i === 1 ? _this17.wrap(accum) : accum, _this17.wrap(n), i);
        });
      }
    ...
    value: function () {
      function dive() {
        ...
        return this.single(name, function (n) {
          ...
          var el = (0, _getAdapter2['default'])(_this23[OPTIONS]).nodeToElement(n);
          if (!(0, _Utils.isCustomComponentElement)(el, adapter)) {
            throw new TypeError('ShallowWrapper::' + name + '() can only be called on components');
          }
          return _this23.wrap(el, null, (0, _object2['default'])({}, _this23[OPTIONS], options));
        });
      }
